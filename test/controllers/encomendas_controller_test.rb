...
class EncomendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create encomenda" do
    assert_difference('Encomenda.count') do
      post encomendas_url, params: { encomenda: { apartamento_id: @encomenda.apartamento_id, data_chegada: @encomenda.data_chegada, destinatario: @encomenda.destinatario, obs: @encomenda.obs, remetente: @encomenda.remetente, tipo: @encomenda.tipo } }
    end
  ...
  test "should update encomenda" do
    patch encomenda_url(@encomenda), params: { encomenda: { apartamento_id: @encomenda.apartamento_id, data_chegada: @encomenda.data_chegada, destinatario: @encomenda.destinatario, obs: @encomenda.obs, remetente: @encomenda.remetente, tipo: @encomenda.tipo } }
